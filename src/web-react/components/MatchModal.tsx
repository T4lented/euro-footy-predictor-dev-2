...
export function MatchModal({ fixture, onClose }: MatchModalProps) {
  ...
  return (
    ...
    >
      <div
        className="glass-strong my-8 w-full max-w-2xl shadow-2xl"
      ...
      >
        <div className="flex items-start justify-between gap-3 border-b p-5" style={{ borderColor: 'var(--border-glass)' }}>
          ...
          <button
            onClick={onClose}
            className="glass glass-hover shrink-0 p-1.5 transition-colors"
        ...
        <div className="space-y-6 p-5">
          {fixture.live && fixture.live.state !== 'pre' && (
            <div className="glass p-4">
              ...
              {fixture.stats && fixture.stats.length > 0 && (
                <div className="mt-4 space-y-1.5 border-t pt-3" style={{ borderColor: 'var(--border-glass)' }}>
                  <p className="mb-1 font-mono text-[10px] uppercase tracking-wide" style={{ color: 'var(--text-muted)' }}>
                    Live match stats
                  </p>
                  {fixture.stats.map((s) => (
                    <div key={s.name} className="flex items-center justify-between font-mono text-[11px] tabular">
                      ...
                      <span className="px-2 uppercase tracking-wide" style={{ color: 'var(--text-muted)' }}>{s.name}</span>
            ...
            <div className="glass p-3 text-xs" style={{ color: 'var(--text-secondary)' }}>
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="font-medium" style={{ color: 'var(--text-primary)' }}>
                  {prediction.h2h.totalMatches} meetings
                </span>
                <span>·</span>
